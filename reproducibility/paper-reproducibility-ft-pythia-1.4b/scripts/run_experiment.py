...
HF_MODEL_ID = "/home/b/p/my-data/i/_p/artificial-learners/models/pythia/pythia-1.4b-all-data/final"
BASE_HF_ID = "EleutherAI/pythia-1.4b"
MODEL_FAMILY = "pythia"
MODEL_PARAMS = "1.4B"
RCLONE_DIR = "i:/_p/artificial-learners/models/pythia/pythia-1.4b-all-data"
LOCAL_DIR = Path("/home/b/p/my-data/i/_p/artificial-learners/models/pythia/pythia-1.4b-all-data")
