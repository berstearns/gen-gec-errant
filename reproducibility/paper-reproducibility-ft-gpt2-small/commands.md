...
```bash
rclone copy "i:/_p/artificial-learners/models/2026-02-23-model/gpt2-small-all-data-resume/final" \
    "/home/b/p/my-data/i/_p/artificial-learners/models/2026-02-23-model/gpt2-small-all-data-resume/final" \
    --progress
```

Verify:
```bash
ls /home/b/p/my-data/i/_p/artificial-learners/models/2026-02-23-model/gpt2-small-all-data-resume/final/config.json
```
