...
```bash
rclone copy "i:/_p/artificial-learners/models/smollm2/smollm2-1.7b-all-data/final" \
    "/home/b/p/my-data/i/_p/artificial-learners/models/smollm2/smollm2-1.7b-all-data/final" \
    --progress
```

Verify:
```bash
ls /home/b/p/my-data/i/_p/artificial-learners/models/smollm2/smollm2-1.7b-all-data/final/config.json
```
