...
HF_MODEL_ID = "/home/b/p/my-data/i/_p/artificial-learners/models/smollm2/smollm2-360m-all-data/final"
...
LOCAL_DIR = Path("/home/b/p/my-data/i/_p/artificial-learners/models/smollm2/smollm2-360m-all-data")
