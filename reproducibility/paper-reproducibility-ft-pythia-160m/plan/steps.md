...
- Check if `/home/b/p/my-data/i/_p/artificial-learners/models/pythia/pythia-160m-all-data/final` exists locally
- If not: download from `i:/_p/artificial-learners/models/pythia/pythia-160m-all-data/final` via rclone
