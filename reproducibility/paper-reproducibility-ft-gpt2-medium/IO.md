...
- rclone source: `i:/_p/artificial-learners/models/gpt2/gpt2-medium-all-data-resume/final`
- Local path: `/home/b/p/my-data/i/_p/artificial-learners/models/2026-02-23-model/gpt2-medium-all-data-resume/final`
...
**Input:** rclone remote `i:/_p/artificial-learners/models/gpt2/gpt2-medium-all-data-resume/final`
**Output:** `/home/b/p/my-data/i/_p/artificial-learners/models/2026-02-23-model/gpt2-medium-all-data-resume/final/` containing HuggingFace model files

**Command:**
```bash
rclone copy "i:/_p/artificial-learners/models/gpt2/gpt2-medium-all-data-resume/final" "/home/b/p/my-data/i/_p/artificial-learners/models/2026-02-23-model/gpt2-medium-all-data-resume/final" --progress
```
